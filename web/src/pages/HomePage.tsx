...
import { ChecklistCard, ChecklistFilters } from '../components';
import '../components/ChecklistList.css';
import './HomePage.css';
...
export function HomePage() {
  ...
  function handleCardClick(checklist: Checklist) {
    navigate(`/detail/${checklist.id}`);
  }
